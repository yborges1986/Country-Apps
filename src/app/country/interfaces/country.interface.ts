// To parse this data:
//
//   import { Convert, RESTCountryResponse } from "./file";
//
...
export class Convert {
  public static toRESTCountryResponse(json: string): Country {
    return cast(JSON.parse(json), r('RESTCountryResponse'));
  }

  public static rESTCountryResponseToJson(value: Country): string {
    return JSON.stringify(uncast(value, r('RESTCountryResponse')), null, 2);
  }
}
...
const typeMap: any = {
  ...
  Currencies: o(
    [
      { json: 'CUC', js: 'CUC', typ: r('Cuc') },
      { json: 'CUP', js: 'CUP', typ: r('Cuc') },
    ],
    false
  ),
  Cuc: o(
